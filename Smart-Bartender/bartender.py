...
class Bartender(MenuDelegate): 
	...
	def menuItemClicked(self, menuItem):
		if (menuItem.type == "drink"):
			if(self.checkPayment() > prev_balance):
	...
	def checkPayment(self):
		...
		api_url_base = 'https://data.ripple.com/v2/accounts/rfykHv9pofAP2psxLiBdeFF1gJ4D5QWaDd/balances'
		api_url = '{0}'.format(api_url_base)
		response = requests.get(api_url)
		y=json.loads(response.content.decode('utf-8'))
		bal=y['balances']
		current_balance = int(bal[0]['value'])
